...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT( /* LOWER */
    ...
    KC_GESC, KC_HOME, KC_PGDN, KC_PGUP, KC_END,          KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_ENT,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_BTN1, KC_BTN2,         KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_QUOT,
...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_SEMICOLON_ENTER] = ACTION_TAP_DANCE_DOUBLE(KC_SCLN, KC_ENT)
};
